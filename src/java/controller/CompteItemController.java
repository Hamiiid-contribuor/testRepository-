...
public class CompteItemController implements Serializable {
    ...
    //*********************hamid 
//    
//     public Double findMontantAffecterBudgetByAnnee (){
//           return ejbFacade.findMontantAffecterBudgetByAnnee(annee);
//     }
    
//    public void findEntiteAdmintratifByBudgetEntiteAdministrtifItem(){
//        this.entiteAdministratif = ejbFacade.findEntiteAdmintratifByBudgetEntiteAdministrtifItem(selected);
//    
    
//    
//    public void findByCriteres(){
//        items = ejbFacade.findByCriteres(entiteAdministratif , Valider , annee);
//    }
    
    
    public void destroy(CompteItem compteItem ){
        selected =compteItem ;
        destroy();
    }
    public void update(CompteItem compteItem ){
        selected =compteItem ;
    }
